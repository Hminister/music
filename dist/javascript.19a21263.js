...
function () {
  ...
  _createClass(Player, [{
    ...
    value: function formateTime(secondsTotal) {
      var mimutes = parseInt(secondsTotal / 60);
    ...
    value: function locateLyric() {
      ...
      if (currentTime > nextLineTime && this.lyricIndex < this.lyricsArr.length - 1) {
        this.lyricIndex++;
        var node = this.$("[data-time=\"".concat(this.lyricsArr[this.lyricIndex][0], "\""));
    ...
    key: "setProgeressBar",
    value: function setProgeressBar() {
...
},{"./icon.js":"src/javascript/icon.js","./swiper":"src/javascript/swiper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
